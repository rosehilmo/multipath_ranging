...
sys.path.append('/Users/rhilmo/Documents/GitHub/multipath_ranging/')
...
import pandas as pd
from common.util import datetimeToEpoch
from brydes_marianas.event_analyzer import EventAnalyzer
...
for site_ind in range(0,7): #range(13,len(sta_table['Sites'])):
    ...
    CHUNK_FILE = station+'_mp_Brydes_TEST.csv'  #file name changes depending on station
    DET_PATH = CHUNK_FILE
