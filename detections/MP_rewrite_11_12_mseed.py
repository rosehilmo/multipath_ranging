...
CHUNK_FILE = "GulfCadiz12_test_MP_halfwidth_20min.csv" #"AlaskaFins_LA21_chunk.csv" #Name of saved call file
...
PLOTFLAG_STACK = True
CLIENT_CODE = 'IRIS'
network="ZZ" #Network name "OO" for OOI, "7D" for Cascadia, "XF" for GulfCadiz12, "XO" for alaska, "YO" for ENAM, "9A" for Hawaii, "ZZ" for puerto rico
station= "XABV" #"LD41" # "B19" for GulfCadiz12 station #Specific station, or '*' for all available stations "X06" for ENAM, "LOSW" for Hawaii, "XABV" for puerto rico
...
DET_PATH="GulfCadiz12_test_MP_halfwidth_20min.csv" #"AlaskaFins_LA21.csv" #Final save file
...
if FINFLAG:
    ...
    ######Portugal pulse kernel parameters MP##############
...
#STARTTIME = ("2013-01-18T00:30:00.000") #GulfCadiz12 amp test
#ENDTIME = ("2013-01-18T09:00:00.000")

#STARTTIME = ("2015-12-27T18:34:00.000") #GulfCadiz12 amp test #2
#ENDTIME = ("2015-12-27T22:00:00.000")
...
#STARTTIME = ("2019-04-25T07:10:00.000") #for GulfCadiz12 fins
...
#STARTTIME = ("2013-01-14T22:25:00.000") # for fin max call testing GulfCadiz12 #1
#ENDTIME = ("2013-01-15T12:00:00.000")

#STARTTIME = ("2012-03-12T19:30:00.000") # for fin max call testing GulfCadiz12 #2
#ENDTIME = ("2012-03-12T21:59:00.000")

#STARTTIME = ("2013-01-21T02:00:00.000") # for fin max call testing GulfCadiz12 #3
#ENDTIME = ("2013-01-21T06:00:00.000")

#STARTTIME = ("2012-03-30T21:00:00.000") # for fin max call testing GulfCadiz12 #4
#ENDTIME = ("2012-03-30T23:00:00.000")

#STARTTIME = ("2013-01-19T22:08:00.000000Z") # for fin automation GulfCadiz12
...
st_raw=read("/Users/wader/Desktop/whaletracks/whaletracks/detection/deep_050915.Z.00.00.2008.009.00.00.00.seed")
...
def main(STARTTIME, ENDTIME,
    ...
    if os.path.isfile(CHUNK_FILE) and is_restart:
        ...
        auto_df_full = [pd.read_csv('auto_GulfCadiz12_test_MP_halfwidth_20min.csv')]
        stack_df_full = [pd.read_csv('stack_GulfCadiz12_test_MP_halfwidth_20min.csv')]
    else:
        analyzers = []
        auto_df_full = []
        stack_df_full = []
    ...
    while utcend > utcstart_chunk:
        ...
        for idx in range(1, num_sta+1):
            ...
            if MP_SPCT_FLAG and len(analyzer_j.df) > 1: #if MP_FLAG is True
                ...
                new_auto_df.to_csv('auto_GulfCadiz12_test_MP_halfwidth_20min.csv', index=False)
                new_stack_df.to_csv('stack_GulfCadiz12_test_MP_halfwidth_20min.csv', index=False)
        ...
        try:
            pickle.dump([datetimearray,ar,yax],open("peaks_GulfCadiz12_test_MP_halfwidth_20min_stack.p","wb"))
        except:
            continue     
    ...
    #pickle.dump([datetimearray,ar,yax],open("peaks_GulfCadiz12_stack.p","wb"))
    #import pdb; pdb.set_trace()
