...
#peaks=pickle.load(open("peaks_Marianas_B19_v2_edit_stack.p","rb"))
...
df_calls=pd.read_csv('Marianas_B19_v2.csv')
...
"""
df1=pd.read_csv('stack_Marianas_B19_v2.csv') 
...
t1=0
df1=pd.read_csv('auto_Marianas_B19_v2.csv')  
...
suminds = np.where(np.array(auto_count) > 10)
...
saveranges.to_csv('Marianas_auto_lowamp_test.csv', index=False)
