...
CHUNK_FILE = "GulfCadiz_test_MP_halfwidth_hydrophone_v3.csv" #"AlaskaFins_LA21_chunk.csv" #Name of saved call file
...
DET_PATH="GulfCadiz_test_MP_halfwidth_hydrophone_v3.csv" #"AlaskaFins_LA21.csv" #Final save file
...
if FINFLAG:
    ...
    ######Gulf of Cadiz pulse kernel parameters MP##############
    F0 = 22 #average start frequency
    F1 = 18 #average end frequency
    BDWDTH = 3 # average bandwidth
    DUR = .8 #average duration
...
st_raw=read("/Users/wader/Desktop/whaletracks/whaletracks/detection/GulfCadiz/050907.H.00.00.2008.070.00.00.00.mseed")
...
def main(STARTTIME, ENDTIME,
    ...
    if os.path.isfile(CHUNK_FILE) and is_restart:
        ...
        auto_df_full = [pd.read_csv('auto_GulfCadiz_test_MP_halfwidth_hydrophone_v3.csv')]
        stack_df_full = [pd.read_csv('stack_GulfCadiz_test_MP_halfwidth_hydrophone_v3.csv')]
    else:
        analyzers = []
        auto_df_full = []
        stack_df_full = []
    ...
    while utcend > utcstart_chunk:
        ...
        for idx in range(0, num_sta+1-1):
            ...
            if MP_SPCT_FLAG and len(analyzer_j.df) > 1: #if MP_FLAG is True
                ...
                new_auto_df.to_csv('auto_GulfCadiz_test_MP_halfwidth_hydrophone_v3.csv', index=False)
                new_stack_df.to_csv('stack_GulfCadiz_test_MP_halfwidth_hydrophone_v3.csv', index=False)
        ...
        try:
            pickle.dump([datetimearray,ar,yax],open("peaks_GulfCadiz_test_MP_halfwidth_hydrophone_v3_stack.p","wb"))
        except:
            continue     
